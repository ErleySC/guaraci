...
Nenhuma métrica desta página vem do acervo cedido ao autor; nenhuma métrica
daqui deve aparecer no TCC como resultado dos óleos amazônicos.
...
`GUARACI_DATASETS_DIR` — `docs/auditoria/datasets_publicos.py` já aceita
caminho de arquivo.
