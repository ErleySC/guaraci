...
NAO LANCADO (pos-v31.9.0) — 2026-08-16 — DD-SIMCA: Q de treino sai da
             ...
             Medido (docs/auditoria/medir_ddsimca_loo_vs_insample.py,
...
NAO LANCADO (pos-v31.9.0) — 2026-08-16 — dados_io: unificacao de mae_id da
             ...
             de uma especie cujo conjunto puro tem ~3 espectros (seria ~25%
             de contaminacao). Excluido via
...
NAO LANCADO (pos-v31.9.0) — 2026-08-16 — Monte Carlo CV: falha por poucos
             ...
             fisicas). Nao afeta este dataset (~44 grupos/classe, folga de
             mais de 10x).
...
NAO LANCADO (pos-v31.9.0) — 2026-08-16 — Etapa 4: iPLS entra no nested-CV
             ...
             positivo em 12/12 seeds** (docs/auditoria/
...
NAO LANCADO (pos-v31.9.0) — 2026-08-16 — RETRATACAO de achado de auditoria
             ...
             **nao se sustentou na medicao e foi retirada**. O raciocinio
             ...
             incluindo o real (~44 grupos mae_id por classe), com BA
             variando de 0,86 a 1,00 entre celulas -- confirmando que o 0%
             nao e' artefato de problema facil demais. Script:
             docs/auditoria/medir_monte_carlo_descarte.py. O guard e'
...
NAO LANCADO (pos-v31.9.0) — 2026-08-16 — dados_io: 5 amostras adulteradas
             deixam de entrar no dataset como PURAS (achado A2-2 da
             auditoria de gate 0). Inspecao manual dos 7 arquivos que
             `carregar_dx` reportava como "isolated orphans" (TITLE nao
             casou com `_RE_TITLE`) achou algo mais serio que agrupamento
             perdido: 5 dos 7 tinham erro de digitacao no ##TITLE=
             ...
             entrava no dataset com conc=0.0/puro=True. Duas Andirobas,
             uma Castanha do Para, uma Maracuja e um Pracaxi adulterados
             (7,15%/13%/6,28%/0,96%) estavam contaminando o conjunto
             "puros" usado para treinar o DD-SIMCA one-class dessas 4
             especies.
...
NAO LANCADO (pos-v31.9.0) — 2026-08-16 — DD-SIMCA: limiar calibrado por
             ...
             ENTRE amostras.
             Medido no dataset real (auditoria A2, 2026-08-16): 12 das 13
             especies tem exatamente 1 mae_id puro independente -- ou
