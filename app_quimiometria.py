...
Engine: pipeline_quimiometria_14.py (dynamically imported).
...
_PIPELINE_PATH = os.path.join(_AQUI, "pipeline_quimiometria_14.py")
...
def _carregar_motor():
    ...
    _mod_name = "pipeline_quimiometria_14"
    if _mod_name in sys.modules:
        del sys.modules[_mod_name]

    try:
        import pipeline_quimiometria_14 as _pq  # type: ignore[import]
...
def _gerar_pdf_relatorio(pasta: str, projeto: Dict,
    ...
    pdf.multi_cell(0, 5,
                   ...
                   "Engine: pipeline_quimiometria_14.py | Interface: app_quimiometria.py. "
...
def _gerar_word_relatorio(pasta: str, projeto: Dict,
    ...
    nota = doc.add_paragraph(
        ...
        "Engine: pipeline_quimiometria_14.py | GEAAp/UFPA — PIBIC Project."
    )
    if nota.runs:
